...
print('Num scalars ' + str(ns))
print('Num points ' + str(np))
...
print('Data start at ' + str(nl_hdr))
...
np = len(x_data)
print('Num point of coor ' + str(np))

y_data = []
for j in range(1,ns+1):
    print("Scalar " + str(j))
    print(' Start line ' + str(nl_hdr+j))
    y_data.append([])
