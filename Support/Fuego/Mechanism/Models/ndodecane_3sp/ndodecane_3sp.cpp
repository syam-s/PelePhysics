...
static AMREX_GPU_DEVICE_MANAGED double inv_molecular_weights[3] = {
...
void get_imw(double imw_new[]){
    for(int i = 0; i<3; ++i) imw_new[i] = inv_molecular_weights[i];
}
...
void egtransetCOFETA(double* COFETA) {
    COFETA[0] = -9.53395626E+00;
    COFETA[1] = -2.09548278E+00;
    COFETA[2] = 5.16271953E-01;
    COFETA[3] = -2.85012704E-02;
...
void egtransetCOFLAM(double* COFLAM) {
    COFLAM[0] = -1.17923278E+01;
    COFLAM[1] = 4.40896497E+00;
    COFLAM[2] = -1.73024560E-01;
    COFLAM[3] = -4.42005312E-03;
...
void egtransetCOFD(double* COFD) {
    COFD[0] = -1.44331296E+01;
    COFD[1] = 8.41942943E-01;
    COFD[2] = 2.37470782E-01;
    COFD[3] = -1.52471999E-02;
    COFD[4] = -2.26775334E+01;
    COFD[5] = 5.51592833E+00;
    COFD[6] = -4.75325322E-01;
    COFD[7] = 1.95715263E-02;
    COFD[8] = -2.25658525E+01;
    COFD[9] = 5.51389289E+00;
    COFD[10] = -4.78413122E-01;
    COFD[11] = 1.98371302E-02;
    COFD[12] = -2.26775334E+01;
    COFD[13] = 5.51592833E+00;
    COFD[14] = -4.75325322E-01;
    COFD[15] = 1.95715263E-02;
    ...
    COFD[24] = -2.25658525E+01;
    COFD[25] = 5.51389289E+00;
    COFD[26] = -4.78413122E-01;
    COFD[27] = 1.98371302E-02;
